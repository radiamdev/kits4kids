                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="tf__event_details_text mt_35 wow fadeInUp">
                            ...
                            <p>
                                Wras congue, sapien sed mollis accumsan, justo
                                orci pulvinar nisl, ut fermentum ante velit in
                                ante. Vivamus blandit urna urna, quis tincidunt
                                turpis sagittis ut. In interdum sem quis congue
                                accumsan. Pellentesque convallis scelerisque
                                eros far away, behind the word mountains far
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-6 col-lg-6 wow fadeInUp">
                                    <div className="tf__event_det_center_text">
                                        <h3>
                                            Qualified And Highly Equipped Elit
                                            ut aliquam purus.
                                        </h3>
                                        <p>
                            ...
                            <p>
                                ...
                                ante. Vivamus blandit urna urna, quis tincidunt
                                turpis sagittis ut. In interdum sem quis congue
                                accumsan. Pellentesque convallis
                                scelerisque.{' '}
                            </p>
                        </div>
                    </div>
