const eventData = [
    ...
    },
    {
        ...
        longTitle:
            'Tech Innovators Conference - Explore the Latest Tech Trends',
...
const faqData = [
    {
        ...
        answer: 'Admission requirements may vary depending on the grade level. Generally, we require a completed application form, transcripts, letters of recommendation, and a personal statement. Please visit our website or contact our admissions office for specific details.',
    },
    {
        id: 1,
        color: 'green',
        question: 'Do you offer financial aid or scholarships for students?',
        answer: 'Yes, we offer financial aid and scholarships to eligible students. Our financial aid packages are based on financial need and academic merit. To apply for financial aid or scholarships, please fill out the appropriate forms available on our website.',
    },
    {
        id: 2,
        color: 'red',
        question: 'What extracurricular activities are available for students?',
        answer: 'We offer a wide range of extracurricular activities, including sports, arts and crafts, debate club, and more. Students can explore their interests and passions outside of the classroom. Our school believes in a well-rounded education.',
    },
    {
        id: 3,
        color: 'blue',
        question: "How can parents get involved in their child's education?",
        answer: "We encourage parental involvement in a child's education. Parents can attend parent-teacher conferences, join the PTA (Parent-Teacher Association), volunteer for school events, and stay connected with teachers and staff through regular communication channels.",
    },
]
...
const allFaqData = [
    ...
    },
    {
        id: 3,
        color: 'blue',
        title: 'Why did we choose BTEC Level 3 International?',
        desc: 'More than just an academic program, BTEC Level 3 International is an international program recognized globally and is delivered today in schools and colleges in 50 countries - with Kits4Kids International being the first authorized center in Madagascar. Level 3 International Extended Diploma is equivalent to 3 international A levels while the Level 3 International Diploma is equivalent to 2 international A levels making it a prominent pathway for students who wish to further their education and those who wish to get a head-start in the professional market.',
    },
    {
        id: 4,
        color: 'orange',
        title: 'Pearson BTEC Level 3 International',
        desc: 'At Kits4Kids International, we are committed to providing our students with world-class educational opportunities that prepare them for success in a rapidly evolving global landscape. One of the most impactful programs we offer is the Pearson BTEC Level 3 International, with pathways in Business and Hospitality, designed to bridge the gap between academic learning and real-world application.',
    },
    {
        id: 5,
        color: 'green',
        title: 'What is BTEC Level 3 International?',
        desc: 'The BTEC Level 3 International Program is a globally recognized qualification known for its practical, hands-on approach to education. Unlike traditional academic routes, BTEC courses emphasize the development of skills that are directly applicable to real-world industries, making it an excellent choice for students looking to gain both academic knowledge and practical experience.',
    },
    {
        id: 6,
        color: 'blue',
        title: 'Why Choose BTEC?',
        desc: "The BTEC Level 3 International is an ideal choice for students who are eager to engage in a more practical and skills-based approach to learning. Here are a few reasons why BTEC stands out: Real-World Learning(BTEC emphasizes practical projects, teamwork, and problem-solving, giving students a strong foundation in the day-to-day skills needed for their chosen career.), Career Readiness(BTEC graduates are highly regarded by employers. The coursework is designed to develop the competencies needed for success in industries like business and hospitality, including communication, leadership, and innovation.), Flexibility(The BTEC program allows students to focus on areas they are passionate about. Whether it's marketing, event management, or entrepreneurship in the business sector, or culinary arts and hotel management in hospitality, students can tailor their studies to align with their career goals.), Global Recognition(The Pearson BTEC qualification is internationally recognized, giving students the opportunity to pursue higher education or careers worldwide.)",
    },
    {
        id: 7,
        color: 'orange',
        title: 'Pathway to Higher Education',
        desc: 'BTEC Level 3 International is also an excellent pathway to university. Its focus on both academic rigor and practical skills ensure students are well-prepared for the demands of higher education, particularly in fields related to business and hospitality.',
    },
    {
        id: 8,
        color: 'orange',
        title: 'BTEC at Kits4Kids International',
        desc: 'Our BTEC students benefit from a learning environment that goes beyond the classroom. They engage in internships, hands-on projects, and community service, all of which allow them to apply what they learned in real-world settings. Our curriculum is designed to nurture their leadership skills, global awareness, and entrepreneurial spirit - qualities that are critical for future leaders in any industry. \nIn addition, students also benefit from skill-based programs such as Career Linguistics and Life Mastery Class which allow them not only to build up their profile but equip them with transfer, language and cultural skills that will help them thrive in their tertiary education and professional careers. ',
    },
    {
        id: 9,
        color: 'orange',
        title: 'Preparing Students for a Dynamic Future',
        desc: 'The BTEC Level 3 International at Kits4Kids International offers more than just a diploma. It equips students with the skills, knowledge, and confidence they need to thrive in a competitive, fast-paced world. Whether our graduates choose to further their education or enter the workforce directly, they leave with the tools to succeed and make an impact. \nWe are proud to offer the BTEC Level 3 International program as part of our commitment to empowering students to lead and make a difference, both locally and globally.',
    },
    {
        id: 10,
        color: 'orange',
        title: 'Join the Conversation',
        desc: 'Have any questions about the BTEC Level 3 International program at Kits4Kids International? Get in touch with us to learn about how this program can help your child achieve their dreams.',
    },
]
...
const blogData = [
    ...
    },
    {
        ...
        longTitle:
            'Delicious and Nutritious: Healthy Recipes for a Balanced Diet',
    ...
    },
    {
        ...
        longTitle:
            'The Future of Artificial Intelligence: Trends and Innovations',
    ...
    },
    {
        ...
        longTitle:
            'Exploring Hidden Gems: Off-the-Beaten-Path Travel Destinations',
...
const services = [
    {
        ...
        title: 'Empowering Team',
        desc: 'Team of passionate, dedicated, active and energetic teachers consistently benefiting from professional and personal development growth opportunities and collaborative practices.',
        link: '/about-us',
        color: 'red',
    },
    {
        ...
        desc: 'Program focused on the student as a whole person and going beyond academics. Birthplace of the Pioneering Leaders Pathway: adopting a holistic approach to education and focusing on building up skills and the student profile.',
        link: 'https://sites.google.com/view/pioneeringleaderspathway/about',
        color: 'blue',
    },
    {
        id: 2,
        ...
        desc: 'Community oriented school participating actively in the life and development of the community around the school premises through diverse charity actions, personal community projects and community service.',
        link: '/about-us',
        color: 'gray',
    },
    {
        ...
        desc: 'International standard education at a fair price and cost on the middle-class and blue-collar education market. First BTEC center approved by Pearson in Madagascar. International assessments and evaluations (ACER ISA, College Board SAT).',
        link: 'https://kits4kidsmada.org/2024/10/15/all-about-btec-level-3-international/',
        color: 'green',
    },
]
...
const courseDataArray = [
    {
        ...
        lessons: '14 lessons',
        description:
            'Learn about development theory in this comprehensive course.',
        rating: 4,
    ...
    },
    {
        ...
        lessons: '23 lessons',
        description:
            'Master the art of photography and take stunning pictures.',
        rating: 4,
...
const teamData = [
    {
        ...
        name: 'Lovasoa Ralaihanitiana',
        designation: 'Founder. Head of School',
        designation2: 'Head of Academics',
        slug: 'lovasoa-ralaihanitiana',
        about: 'N/A',
        mail: 'mailto:lovasoa.r@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 1,
        imgSrc: 'images/team_2.png',
        name: 'Aurelie P.A. Rajaonison',
        designation: 'Head of Operations',
        designation2: 'French & Home Economics Teacher',
        slug: 'aurelie-rajaonison',
        about: 'N/A',
        mail: 'mailto:aurelie.rajaonison@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 2,
        imgSrc: 'images/team_3.png',
        name: 'Rina Ramamonjison',
        designation: 'Head Teacher',
        designation2: 'English Language Arts Teacher',
        slug: 'rina-ramamonjison',
        about: 'N/A',
        mail: 'mailto:rina.ramamonjison@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 3,
        imgSrc: 'images/team_4.png',
        name: 'Tinah A. Ramanantsoa',
        designation: 'Integrated Humanities Teacher',
        designation2: '',
        slug: 'tinah-ramanantsoa',
        about: 'N/A',
        mail: 'mailto:tinah-ramanantsoa@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 4,
        imgSrc: 'images/team_5.png',
        name: 'Patrick A.H. Andrianarivony',
        designation: 'Mathematics Teacher',
        designation2: '',
        slug: 'patrick-andrianarivony',
        about: 'N/A',
        mail: 'mailto:patrick.andrianarivony@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 5,
        imgSrc: 'images/team_6.png',
        name: 'Miora Voahary N.J.E',
        designation: 'Malagasy Teacher',
        designation2: '',
        slug: 'voahary-niaina',
        about: 'N/A',
        mail: 'mailto:voahary.niaina@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 6,
        imgSrc: 'images/team_7.png',
        name: 'Faramalala A.S.P',
        designation: 'Kindergarten Teacher',
        designation2: '',
        slug: 'sylvie-faramalala',
        about: 'N/A',
        mail: 'mailto:sylvie.faramalala@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 7,
        imgSrc: 'images/team_8.png',
        name: 'Justin Rakotomamonjy',
        designation: 'Administration',
        designation2: '',
        slug: 'justin-rakotomamonjy',
        about: 'N/A',
        mail: 'mailto:justin.rakotomamonjy@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 8,
        imgSrc: 'images/team_9.png',
        name: 'Clovis Randriantefiarimanana',
        designation: 'Receptionist',
        designation2: '',
        slug: 'clovis-randriantefiarimanana',
        about: 'N/A',
        mail: 'mailto:clovis@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 9,
        imgSrc: 'images/team_10.png',
        name: 'Marius Van Wik',
        designation: 'Design and Physics Teacher',
        designation2: '',
        slug: 'marius-van-wik',
        about: 'N/A',
        mail: 'mailto:marius.van-wik@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 10,
        imgSrc: 'images/team_11.png',
        name: 'Harinoro Rafenonomentsoa',
        designation: 'Primary English Teacher',
        designation2: '',
        slug: 'harinoro-rafenonomentsoa',
        about: 'N/A',
        mail: 'mailto:harinoro.rafenonomentsoa@kits4kidsmada.org',
        phone: 'N/A',
    },
    {
        id: 11,
        imgSrc: 'images/team_12.png',
        name: 'Lovanirina Rafanomezantsoa',
        designation: 'Librarian',
        designation2: '',
        slug: 'lovanirina-rafanomezantsoa',
        about: 'N/A',
        mail: 'mailto:lovanirina.rafanomezantsoa@kits4kidsmada.org',
        phone: 'N/A',
    },
]
...
const academicLevels = [
    {
        ...
        title: 'Kindergarten',
        description:
            'Our Kindergarten program at Kits4Kids International is designed for students aged 5 years old, focusing on early childhood development and foundational learning. Through active and play-based learning, our Kindergartners develop cognitive, social, and motor skills, while foundation for literacy and numeracy concepts are introduced through engaging activities. Social skills and emotional development are nurtured through group play, fostering cooperation and emotional regulation. Creativity and exploration are encouraged with arts, crafts, music, and movement, creating a love for learning in a safe, nurturing environment that lays the foundation for future academic success.',
    },
    {
        id: 1,
        color: 'green',
        ...
        title: 'Primary',
        description:
            'Our Primary program at Kits4Kids International, from Grade 1 to Grade 5, focuses on building foundational skills and nurturing early leadership. Graders are introduced to basic leadership through teamwork, communication, and decision-making activities. They gain global awareness through storytelling, projects, and cultural exchanges while creativity is fostered through arts, crafts, and problem-solving tasks. Strong academic foundations are built in literacy, numeracy, science, life skills and social studies. By the end of Grade 5, students have a solid understanding of leadership, global citizenship, and are well-prepared for more complex studies, with the ISA serving as a key milestone.',
    },
    {
        id: 2,
        color: 'orange',
        ...
        title: 'Junior School',
        description:
            'The Kits4Kids Junior School (KJS) program for Grade 6 (KJS Year 1) to Grade 10 (KJS Year 5) is hands-on and inquiry-based, designed to develop self-directed and lifelong learners prepared for the BTEC program in Senior High (SH). \nKJS Years 1 to 3 focus on building leadership through conflict resolution, goal setting, and project management, with an emphasis on global issues and critical thinking. Students apply academic knowledge through projects and community service, taking on leadership roles within their school and community. \nKJS Years 4 and 5 emphasize strong leadership, academic excellence, and global citizenship. Upper KJS-ers refine their skills through strategic planning, ethical decision-making, entrepreneurship, and active participation in global leadership activities such as Model United Nations (MUN) simulation. They also engage in advanced studies of global issues across subjects, preparing them for global leadership, with ISA serving as a key milestone at the end of KJS Year 5.\nAt each level, students complete a Personal Community Project (PCP) a key component of the program followed by Kits4Kids International, empowering them to take active roles in their communities, with projects presented in KJS Years 1, 3 and 5.',
    },
    {
        id: 3,
        color: 'blue',
        ...
        description:
            'The SH (Senior High) program at Kits4Kids International focuses on Leadership Mastery and Career Readiness, preparing SH-ers for success in higher education and the global workforce.\nLeadership Mastery is achieved through leading large-scale projects, mentoring younger students, and following the BTEC curriculum. Global Leadership is emphasized by addressing advanced global issues, ethics and sustainability. Students engage in innovative problem solving, working on research projects that prepare them for careers or further studies requiring high levels of innovation. \nWith a strong focus on academic and career readiness, students develop critical thinking, deep knowledge in their chosen fields, and practical skills. They participate in internships, community service, and skills-based programs such as Career Linguistics and Life Mastery Classes. The highly self-directed nature of the program ensures that students graduate ready for global challenges, equipped to thrive as lifelong learners.\nProgression in the SH Program ensures that students master leadership, are career-ready, and prepared for post-secondary education. Active participation and graduation from the BTEC and the option to take the SAT at the end of the program further strengthens the',
    },
]
...
const curriculum = [
    {
        id: 0,
        imgSrc: 'images/curriculum_1.png',
        title: 'Pioneering Leaders Pathway',
        link: 'https://sites.google.com/view/pioneeringleaderspathway/about',
        description:
            'Born through Kits4Kids International, the Pioneering Leaders Pathway (PLP) is designed to nurture and develop future leaders by providing a comprehensive and dynamic educational experience. This program emphasizes leadership development, global awareness, innovation, and academic excellence. It integrates project-based, inquiry-based, collaborative, and experiential learning methodologies to equip students with the skills and knowledge they need to thrive in a rapidly changing world. The PLP is adaptable and scalable, ensuring that it meets the diverse needs of the students and can be implemented in various educational contexts.',
    },
    {
        id: 1,
        imgSrc: 'images/curriculum_2.jpg',
        title: 'Pearson BTEC Level 3 International',
        link: 'https://qualifications.pearson.com/en/qualifications/btec-international-level-3.html',
        description:
            'As an authorized center, Kits4Kids International offers the Pearson BTEC Level 3 International Extended Diploma in Business and Hospitality and the Diploma in Hospitality, providing students with a practical, skills-based education. The BTEC Level 3 International program emphasizes hands-on learning, combining academic theory with real-world application. It is recognized globally for its flexibility, allowing students to tailor their learning to their interests and career goals while developing key skills in problem-solving, communication, and leadership. With strong industry connections and an emphasis on career readiness, BTEC Level 3 International equips students with the qualifications and practical experience to succeed in both higher education and the global workforce.',
    },
    {
        id: 2,
        imgSrc: 'images/curriculum_3.jpg',
        title: 'ACER International Schools Assessment',
        link: 'https://www.acer.org/au/isa',
        description:
            "Kits4Kids International utilizes the ACER (Australian Council for Educational Research) International Schools' Assessment (ISA) as a key tool for evaluating student progress in Grades 3 to KJS Year 5. The ISA is designed to assess skills in reading, mathematical literacy, scientific literacy and writing, aligning with international benchmarks while providing meaningful insights into student development. Its focus on real-world applications and critical thinking ensures that students are not only meeting global standards but also developing the competencies required for success in higher education and beyond. The ISA helps us monitor growth, tailor learning experiences, and ensure students are well-prepared for the challenges of an interconnected world.",
    },
]
