                    ...
                    <div className="col-12 wow fadeInUp">
                        <div className="tf__team_description mt_55">
                            <p>
                                ...
                                Ipsum Fasts There are many variations of
                                passages of Lorem Ipsum Fastsby we are the fast
                                to mane injected humour,by injected humour, or
                                randomised coved ceilings. are bound to ensue;
                                and equal blame belongs can to bo erwtg mont be
                                fao go not be hie best to those who through
                                weakness. There are many variations of passages
                                of Lorem Ipsum Fasts There are many variations
                                of passages of Lorem Ipsum Fastsby we are the
                                fast to mane injected humour,by injected humour,
                                or randomised coved ceilings. are bound to
                                ensue; and equal blame belongs can to bo erwtg
                                mont.
                            </p>
                    ...
                    <div className="row wow fadeInUp">
                        <div className="col-xl-6 col-md-8 col-lg-6 m-auto">
                            <div className="tf__heading_area mb_15">
                                <h5>OUR Meet Team</h5>
                                <h2>
                                    Become A Instruction Instructor Teacher.
                                </h2>
                            </div>
                        </div>
                    </div>
