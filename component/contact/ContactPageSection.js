                ...
                <div className="row">
                    <div className="col-xxl-8 col-xl-7 col-lg-6 wow fadeInLeft">
                        <div className="tf__contact_form">
                            ...
                            <p>
                                Promote your blog posts, case udie, and product
                                ouncems with the the branded videoscustomers
                                coming back for services Makes best effort.
                            </p>
                            <ContactForm />
                        </div>
                    </div>
                    <div className="col-xxl-4 col-xl-5 col-lg-6 wow fadeInRight">
                        <div className="tf__contact_text">
                            <div className="tf__contact_single">
                                ...
                                <div className="text">
                                    <h3>Call</h3>
                                    <a href="callto:+880254615566">
                                        +880254615566
                                    </a>
                                    <a href="callto:+826542556455">
                                        +826542556455
                                    </a>
                                </div>
                            </div>
                            <div className="tf__contact_single">
                                ...
                                <div className="text">
                                    <h3>mail</h3>
                                    <a href="mailto:neta@eobi.com">
                                        neta@eobi.com
                                    </a>
                                    <a href="mailto:coraty@bara.com">
                                        coraty@bara.com
                                    </a>
                                </div>
                            </div>
